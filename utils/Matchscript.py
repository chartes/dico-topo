...
with open("/home/corentink/Bureau/Dicotopo/DT62/listcommune.csv", newline='') as csvfile:
...
with open("/home/corentink/Bureau/Dicotopo/DT62/Rest2_prepared.csv", newline='') as csvfile:
...
with open("/home/corentink/Bureau/Dicotopo/DT62/result2.csv","w", newline='') as csvfile:
...
with open("/home/corentink/Bureau/Dicotopo/DT62/result3.csv","w", newline='') as csvfile:
    fichierfinal = csv.writer(csvfile, delimiter=',')
    for ligne in listresultat2 :
        fichierfinal.writerow(ligne)

#Il crée un fichier avec les communes qui n'ont matché avec aucune commune de l'INSEE 2018
with open("/home/corentink/Bureau/Dicotopo/DT62/rest3.csv","w", newline='') as csvfile:
    fichierfinal = csv.writer(csvfile, delimiter=',')
